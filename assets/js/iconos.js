// ─────────────────────────────────────────────
// ICONOS — set compartido de SVG inline (24x24, stroke currentColor,
// stroke-width 2, cabos/uniones redondeados, sin relleno salvo donde
// se indica), para no reimplementar el mismo ícono con emoji distinto
// en cada página. Cargar este script ANTES del script de la página
// que lo use (comercios.js, ficha.js, prospector.js, encuestas.js).
//
// Los 6 canales de contacto + "puntos" (menú de tres puntos) y
// "facebook" son los mismos que ya existían sueltos en comercios.js;
// viven acá para poder reusarse en ficha.js/prospector.js/encuestas.js
// sin duplicar el string SVG en cada archivo — ver B1 en
// [[eleva-lab-auditoria-diseno-admin]].
// ─────────────────────────────────────────────
const ICONS = {
  // ── Canales de contacto (ya existían en comercios.js) ──────────
  ...
  // ── Nuevos, agregados en B1 (relevamiento de iconografía funcional) ──
  editar: '<svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 20h9"/><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4Z"/></svg>',
  eliminar: '<svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 6h18"/><path d="M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/><path d="M19 6l-1 14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2L5 6"/><line x1="10" y1="11" x2="10" y2="17"/><line x1="14" y1="11" x2="14" y2="17"/></svg>',
  auditar: '<svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 5H7a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2h-2"/><rect x="9" y="3" width="6" height="4" rx="1"/><path d="m9 14 2 2 4-4"/></svg>',
  ...
  carpeta: '<svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 7a2 2 0 0 1 2-2h4l2 2h8a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2Z"/></svg>',
  ...
  archivo: '<svg viewBox="0 0 24 24" width="32" height="32" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 15V3"/><path d="m7 8 5-5 5 5"/><path d="M4 15v4a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-4"/></svg>',
